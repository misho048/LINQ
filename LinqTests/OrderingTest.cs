...
namespace LinqTests
{
    ...
    public class OrderingTest
    {
        ...
        {
            IEnumerable<string> actual = Ordering.OrderBy01();
            IEnumerable<string> expected = new string[] { "apple", "blueberry", "cherry" };
        ...
        {
            IEnumerable<string> actual = Ordering.OrderBy02();
            IEnumerable<string> expected = new string[] { "apple", "cherry", "blueberry" };
        ...
        public void TestOrderBy03()
        {
            ...
            IEnumerable<Product> actual = Ordering.OrderBy03();
            IEnumerable<Product> expected =
                new Product[]
                {
        ...
        [TestMethod]
        public void TestOrderByDescending01()
        {
            IEnumerable<double> actual = Ordering.OrderByDescending01();
            IEnumerable<double> expected = new double[] { 4.1, 2.9, 2.3, 1.9, 1.7 };

            CollectionAssert.AreEqual(actual.ToList(), expected.ToList(), "You failed!");
        }

        [TestMethod]
        public void TestOrderByDescending02()
        {
            IEnumerable<Product> actual = Ordering.OrderByDescending02();
            IEnumerable<Product> expected =
                new Product[]
                {
                    new Product { ProductID=75, ProductName="Rhönbräu Klosterbier",  Category="Beverages", UnitPrice=7.7500M, UnitsInStock=125              },
        ...
        {
            IEnumerable<string> actual = Ordering.ThenOrderBy();
            IEnumerable<string> expected = new string[] { "one", "six", "two", "five", "four", "nine", "zero", "eight", "seven", "three" };
        ...
        {
            IEnumerable<string> actual = Ordering.Reverse();
            IEnumerable<string> expected = new string[] { "nine", "eight", "six", "five" };
